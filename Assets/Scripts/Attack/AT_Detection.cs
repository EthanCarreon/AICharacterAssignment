...
namespace NodeCanvas.Tasks.Actions
{
    ...
    public class AT_Detection : ActionTask
    {

        public LayerMask theifLayer;
        ...
        {
            // CODE USED AND HELPED FROM KEELY BROWN - WEEK 10 EXERCISE

            Transform bestTarget = null;
            float bestValue = Mathf.Infinity;

            Collider[] detectedThiefColliders = Physics.OverlapSphere(agent.transform.position, detectionRadius, theifLayer);
